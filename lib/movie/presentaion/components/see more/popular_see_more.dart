...
class PopularSeeMoreComponent extends StatefulWidget {
  const PopularSeeMoreComponent({super.key});

  @override
  State<PopularSeeMoreComponent> createState() =>
      _PopularSeeMoreComponentState();
}

class _PopularSeeMoreComponentState extends State<PopularSeeMoreComponent> {
